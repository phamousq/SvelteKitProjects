<script lang="ts">
	...
	let percentCorrect = $derived(
		isNaN(+((correctCount / countComplete) * 100).toFixed(1))
			? 100
...
<main>
	...
	<div class="date-navigation">
		<Button color="blue" onclick={goToPreviousDay}>&lt; Previous Day</Button>
	...
	<div class="h-[300px] rounded border p-4">
		<AreaChart data={lastSevenDaysData()} x="date" y="count" points labels={{ offset: 10 }} />
	</div>
